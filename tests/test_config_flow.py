    ...
    [
        (
            ...
            "config_2",
            {
                ...
                "scan_interval": 20,
                "custom_days": 3,
                "sec_amazon": {"amazon_enabled": True},
            },
            "config_amazon",
            {
...
async def test_form(
    ...
    with (
        ...
        auth_input = (
            {"auth_type": input_1.pop("auth_type", "password")}
...
@pytest.mark.asyncio
async def test_reconfigure_flow_skip_to_storage(
    hass, mock_imap_no_email, integration_no_amazon
):
...
@pytest.mark.asyncio
async def test_reconfig_3_validation_error(
    hass, mock_imap_no_email, integration_no_amazon
):
...
@pytest.mark.asyncio
async def test_reconfig_storage_validation_error(
    hass, mock_imap_no_email, integration_no_amazon
):
