...
FAKE_CONFIG_DATA = {
    ...
    "post_de_custom_img_file": "custom_components/mail_and_packages/mail_none.gif",
    "custom_img": False,
    "folder": '"INBOX"',
    "generate_mp4": False,
    "gif_duration": 5,
...
FAKE_UPDATE_DATA = {
    ...
    "usps_delivered_tracking": ["92123456789012345"],
    "ups_delivered": 1,
    "ups_delivering": 1,
    "ups_packages": 1,
    ...
    "amazon_delivered_orders": ["#123-4567890"],
    "amazon_hub": 2,
...
FAKE_UPDATE_DATA_REDACTED = {
    ...
    "usps_delivered_tracking": "**REDACTED**",
    "ups_delivered": 1,
    "ups_delivering": 1,
    "ups_packages": 1,
